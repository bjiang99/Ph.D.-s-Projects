...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='results_jaccard/128_0.1_200_256_300_model_TINY_conventional_SSL.pth',
...
#     results['test_acc@5'] = df['test_acc@5'].to_list()[0:broken_point-1]
    ...
    for epoch in range(broken_point, epochs + 1):
        ...
        data_frame.to_csv('results_jaccard/linear_128_0.1_200_256_300_statistics_TINY_conventional_SSL.csv', index_label='epoch')
...
#             torch.save(model.state_dict(), 'results_jaccard/linear_128_0.1_200_512_500_model_cifa100.pth')
            torch.save(model.module.state_dict(), 'results_jaccard/linear_128_0.1_200_256_300_model_TINY_jaccard_conventional_SSL.pth')
